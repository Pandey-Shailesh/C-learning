...
and can be accessed easily which is a major drawback of the structure because structures cannot be used where data security is a major concern.
...
public:
  int d, e;
  void setdata(int a1, int b1, int c1); //  function declartion
  void getdata()
  {
...
{
  employee harry;
  // harry.a=157;------>This will throw erroras a private
  harry.d = 84;
  harry.e = 98;
  harry.setdata(4, 5, 6);
  harry.getdata();
